...
namespace Sybon.Auth
{
    public static class Program
    {
        ...
        private const string ServiceDisplayName = "Sybon.Auth web api";
        private const string ServiceDescription = "Sybon.Auth web api";
    ...
    internal class MyService : IWin32Service
    {
        ...
        public string ServiceName => "Sybon.Auth";
